<?php
    ...
    if(isset($_GET['id_del_cus'])){
        $id = $_GET['id_del_cus'];
        delete_data('customers', $id);
        header("location: data_customers.php"); 
    }
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Customers Data - Admin</title>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            echo "<td class='text-center'> <a href='data_customers.php?id_del_cus={$row['id']}' ><i class='fa-solid fa-trash text-danger'></i></a></td>";
                                            echo "</tr>";
                                            $i++;
                                            }
                                            mysqli_close($conn);
