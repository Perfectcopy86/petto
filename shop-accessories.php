<?php 
    ...
    if(isset($_POST['btn-search5'])){
        if(isset($_POST['search5'])){
            $keyword = "%" . $_POST['search5'] . "%";
            $data = searchProduk(4, $keyword);
        }
    }else{
        $keyword = "%%";
        $data = readQueryJenis(4);
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Pet Accessories</h1>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                             <form action="" method="POST">
                                <div class="input-group">
                                    <input type="text" name="search5" class="form-control" placeholder="Search by name">
                                    <div class="input-group-append">
                                        <button name="btn-search5" class="input-group-text bg-transparent text-warning" type="submit">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                ...
                                <a href="functions/addToCart.php?id_produk=<?= $datas['id'] ?>&url=shop-accessories&harga_produk=<?= $datas['harga'] ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-warning mr-1"></i>Add To Cart</a>
                            </div>
                        </div>
                    </div>  
                    <?php } endforeach; ?>
