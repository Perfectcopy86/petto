<?php
    ...
    if(isset($_GET['id_cus_del'])){
        $id_cus = $_GET['id_cus_del'];
        $id_produk = $_GET['id_produk_del'];
        delete_data_laporan('laporan_pembelian', $id_cus, $id_produk);
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM laporan_pembelian";
                                            ...
                                            echo "<td> {$row['banyak_produk']} </td>";
                                            echo "<td> {$row['total']} </td>";
                                            echo "<td> {$row['waktu_konfirmasi']} </td>";
                                            echo "<td class='text-center'> <a href='laporan_pembelian.php?id_cus_del={$row['id_customers']}&id_produk_del={$row['id_produk']}'><i class='fa-solid fa-trash text-danger mr-2'></i></a></td>";
                                            echo "</tr>";
                                            $i++;
                                            }
                                            mysqli_close($conn);
