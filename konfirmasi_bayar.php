            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Konfirmasi Bayar</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Konfirmasi Bayar</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                List Konfirmasi Bayar
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM customers WHERE status_order='bayar'";
                                            ...
                                            echo "<td class='text-center'> <a href='functions/accept.php?id={$row['id']}' class='btn btn-warning'>Konfirmasi</a></td>";
                                            echo "</tr>";
                                            $i++;
                                            }
                                            mysqli_close($conn);
